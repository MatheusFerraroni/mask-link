...
static esp_err_t index_get_handler(httpd_req_t *req)
{
    ...
    int written = snprintf(
        ...
        ".rssi-ref{font-size:12px;color:#536471;margin-top:4px;line-height:1.35}"
        ...
        "<div class=\"kv\"><b>RSSI</b><span id=\"rssi\">-</span><div class=\"rssi-ref\">-30 a -55 bom; -56 a -65 aceitavel; -66 a -70 degrada; -71 a -80 ruim; abaixo de -80 instavel</div></div>"
